...
description: >
  ...
  커스텀 앱(app-car-manager, app-hscode, app-sales-report, app-stock-management) 개발 시 사용.
...
| 재고예측 | `/app-stock-management` | `db_app_stock` | :3104 | :5204 | `stk_` | `stk_` |
...
// app-sales-report: SAL-E{4자리}, app-stock-management: STK-E{4자리}
