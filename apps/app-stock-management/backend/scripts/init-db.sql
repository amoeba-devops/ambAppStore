...
CREATE TABLE IF NOT EXISTS asm_corporations (
  ...
  crp_code            VARCHAR(50)   NOT NULL UNIQUE,
  crp_name            VARCHAR(200)  NOT NULL,
  crp_biz_no          VARCHAR(20)   NULL,
  crp_representative  VARCHAR(100)  NULL,
  crp_phone           VARCHAR(30)   NULL,
  crp_address         VARCHAR(500)  NULL,
...
CREATE TABLE IF NOT EXISTS asm_products (
  ...
  prd_category        VARCHAR(100)  NULL,
  prd_brand           VARCHAR(100)  NULL,
