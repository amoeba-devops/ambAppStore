...
export const dispatchApi = {
  ...
  update: (id: string, data: Record<string, unknown>) =>
    apiClient.patch(`/v1/dispatches/${id}`, data).then((r) => r.data),
...
export const tripLogApi = {
  ...
  create: (data: Record<string, unknown>) =>
    apiClient.post('/v1/trip-logs', data).then((r) => r.data),
  update: (id: string, data: Record<string, unknown>) =>
  ...
  void: (id: string, data: { reason: string }) =>
    apiClient.patch(`/v1/trip-logs/${id}/void`, data).then((r) => r.data),
