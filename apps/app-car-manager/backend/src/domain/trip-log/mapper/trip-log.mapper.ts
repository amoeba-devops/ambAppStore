...
export class TripLogMapper {
  static toResponse(entity: TripLogEntity): TripLogResponse {
    return {
      ...
      voidedAt: entity.ctlVoidedAt?.toISOString() ?? null,
      voidedBy: entity.ctlVoidedBy ?? null,
      voidedByName: entity.ctlVoidedByName ?? null,
      voidedReason: entity.ctlVoidedReason ?? null,
