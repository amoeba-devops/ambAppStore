...
const VEH_DONGNAI = '29ad0000-0000-4000-8000-000000000201'; // 60C-311.07
const VEH_HCM = '511a3e37-e747-4fe5-917a-b010e2ecf211'; // 29C-99999
...
const ALL_TRIP_IDS = [T_DN_1, T_DN_2, T_HCM_1, T_HCM_2];
...
async function insertTrip(
  ...
  await q`
    INSERT INTO car_trips (
      ...
      trp_fuel_liters, trp_fuel_price, trp_toll_fee, trp_revenue
    ) VALUES (
