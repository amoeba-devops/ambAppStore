...
export async function buildTruckReportWorkbook(
  ...
  const VEH: Col[] = [
    ...
    { h: 'Phí cầu đường', w: 12, key: 'toll', fmt: MONEY, align: 'right' },
    { h: 'Phí xăng dầu', w: 13, key: 'fuel', fmt: MONEY, align: 'right' },
  ...
  const SUM: Col[] = [
    ...
    { h: 'Phí xăng dầu', w: 14, key: 'fuel', fmt: MONEY, align: 'right' },
  ...
  const gloss: [string, string][] = [
    ...
    ['Lợi nhuận (chuyến)', 'Doanh thu − Phí xăng − Phí cầu đường − Chi phí phát sinh (trước chi phí cố định tháng).'],
    ...
    ['Lợi nhuận ròng (tháng)', 'Doanh thu − Phí xăng dầu − Phí cầu đường − Tổng phí phát sinh − Lương tài xế − Khấu hao − Chi phí cố định.'],
