...
export async function GET(req: Request) {
  ...
  /* Columns mirror the screen — no fixed-cost column (REQ-20260908 dropped
   * per-trip salary/depreciation allocation; profit is the variable-only
   * figure everywhere now, same as maintenance never had one). */
  const header = [
